...
const TruyenYeuThich = ({ setIsLoading }: { setIsLoading: (value: boolean) => void }) => {
    ...
    useEffect(() => {
        DanhSachTruyenYeuThich()
    }, [])

    console.log(listTruyenYeuThich);
    return (
        <div style={{ padding: "20px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
            ...
            <Row gutter={[16, 16]}>
                {listTruyenYeuThich.map((truyen: any) => (
